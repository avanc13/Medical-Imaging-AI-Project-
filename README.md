...
1. The `final_models` folder contains model implementations. As of now, we have Network 1 and the least squares implemented.
2. The `data` folder contains raw data that was provided to us.
